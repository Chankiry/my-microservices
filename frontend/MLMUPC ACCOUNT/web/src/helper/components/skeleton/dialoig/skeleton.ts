        ...
        <div *ngFor="let box of boxes" class="flex items-center border-b p-2">
            ...
            <div class="flex items-center justify-end mx-4 flex-grow gap-4">
                ...
                <!-- <div class="flex flex-col flex-grow gap-2">
                    <div class="h-4 bg-gray-200 rounded-full" [style.width]="box.nameWidth"></div>
                    <div class="h-4 bg-gray-200 rounded-full" [style.width]="box.subNameWidth"></div>
                </div> -->
            </div>
...
export class ListingSkeletonDialogComponent implements OnInit {
    boxes = [];

    ngOnInit() {
        // generate 50 rows
        this.boxes = Array.from({ length: 50 }, () => this.generateBox());
    }
