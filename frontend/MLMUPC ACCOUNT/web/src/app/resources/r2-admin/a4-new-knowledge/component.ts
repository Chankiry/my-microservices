...
// ===>> Local
import { AdminNewKnowledgeService }                                                      from './service';

@Component({
    selector    : 'admin-new-knowledge',
    standalone  : true,
...
export class AdminNewKnowledgeComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _service             : AdminNewKnowledgeService,
